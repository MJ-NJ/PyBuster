...
def parse_args():
    parser = argparse.ArgumentParser(description='A simple tool to check for subdomains')
    parser.add_argument('-u', 'url',dest='url',help='URL to scan, will be prefixed to each wordlist line',required=True)
